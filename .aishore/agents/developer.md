...
4. **Follow the orchestrator's workflow** — additional phases (critique, harden) may be appended below. Complete them exactly as specified. When the orchestrator injects a validation command, run it during the harden phase and fix all failures before committing.
